 ...
 */
public class Command_update_id implements Command {
    private ControlUnit controlUnit;
    private Collection collection;


    public Command_update_id(ControlUnit controlUnit, Collection collection) {
    ...
    public void execute(String ... args) throws Exception {
        if (args.length != 2) {
            ...
            controlUnit.update_id(id, collection);
        }
    }
}
